...
describe('form submit', () => {
  it('saves the patient', async () => {
    ...
    {"identifiers": [{"identifier": "", "identifierType": "05a29f94-c0ed-11e2-94be-8c13b969e334", "location": ""}], "person": {"addresses": [{"address1": "", "address2": "", "cityVillage": "", "country": "", "postalCode": "", "stateProvince": ""}], "attributes": [{"attributeType": "14d4f066-15f5-102d-96e4-000c29c2a5d7", "value": ""}], "birthdate": "1993-08-02", "birthdateEstimated": false, "gender": "M", "names": [{"familyName": "Gaihre", "givenName": "Paul", "middleName": "", "preferred": true}]}});
